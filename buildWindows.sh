...
# Adding all sources
# When using "*.cpp" don't include the main file seperately - it will cause a linker error
$SOURCES = "$SRC_DIR\*.cpp" #,"$BASE_DIR\main.cpp", `
...
"-I$LIB_DIR\glm", "-I$LIB_DIR\include", "-I$include_DIR" ###, "-I$LIB_DIR\freetype-win\include",  "-I$IMGUI_DIR", "-I$IMGUI_DIR\backends"
