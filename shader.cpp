...
GLuint Shader::createShader(const char* ColorVertexShaderFilename, const char* fragmentShaderFilename) {
	std::string ColorVertexShaderSource = parse(ColorVertexShaderFilename);
	...
	#ifdef _RELEASE
		glDetachShader(programm, vs);
		glDetachShader(programm, fs);
