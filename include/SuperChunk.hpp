...
public:
	...
	static void setBlock(glm::vec3 pos, int type=0, BlockRotation rot=Y_positive);
    static void setBlock(int x, int y, int z, int type=0, BlockRotation rot=Y_positive);
